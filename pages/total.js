...
export default function Total() {
  const { pedido, nombre, setNombre, submitPedido, total } = useHeladeria();
  ...
  return (
    <Layout titulo="Total">
      ...
      <p className="text-2xl mt-5">
        Confirma tu compra de helados y realiza el pago de manera
        segura
      </p>
      <form onSubmit={submitPedido}>
        ...
        <div className="mt-10">
          <p className="text-2xl">
            Total a pagar: {""}{" "}
            <span className="font-black text-red-500 text-3xl">
          ...
          <input
            ...
            className={`${
              comprobarPedido()
                ...
                : "bg-sky-600 hover:bg-sky-700 transition-all cursor-pointer"
